            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEdit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="nama">Jenis Surat</label>
                           <input type="text" class="form-control" name="jenis_surat" id="ejenis_surat">
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            formTambah.on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ url('v2/396d6585-16ae-4d04-9549-c499e52b75ea/jenis/surat/create') }}',
                    data: formData,
                    dataType: 'JSON',
                    contentType: false,
                    processData: false,
        ...
        $(document).on('click', '.edit-modal', function() {
            ...
            $.ajax({
                url: "{{ url('v2/396d6585-16ae-4d04-9549-c499e52b75ea/jenis/surat/get') }}/" + uuid,
                type: 'GET',
                dataType: 'JSON',
                success: function(data) {
                    console.log(data);
                    $('#uuid').val(data.data.uuid);
                    $('#ejenis_surat').val(data.data.jenis_surat);
        ...
        $(document).ready(function() {
            ...
            formEdit.on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ url('v2/396d6585-16ae-4d04-9549-c499e52b75ea/jenis/surat/update') }}/" +
                        uuid,
                    data: formData,
                    dataType: 'json',
                    contentType: false,
        ...
        $(document).on('click', '.delete-confirm', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $('#loading-overlay').show();
                    $.ajax({
                        url: "{{ url('v2/396d6585-16ae-4d04-9549-c499e52b75ea/jenis/surat/delete/') }}/" +
                            uuid,
                        type: 'DELETE',
                        data: {
                            "_token": "{{ csrf_token() }}",
